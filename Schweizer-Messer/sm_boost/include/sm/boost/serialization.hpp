...
#define SM_BOOST_CLASS_VERSION(CLASS_T) BOOST_CLASS_VERSION(CLASS_T, CLASS_T::CLASS_SERIALIZATION_VERSION)
...
#define SM_BOOST_CLASS_VERSION_T1(CLASS_T)                                                   \
    ...
    struct version<CLASS_T<T1> > {                                                           \
        ...
        BOOST_MPL_ASSERT((boost::mpl::less<boost::mpl::int_<NNN>, boost::mpl::int_<256> >)); \
    };                                                                                       \
    }                                                                                        \
    }
