...
TEST(SerializationMacros, TestClassSharedPtrHasMethodDeduction) {
    ...
    ASSERT_EQ(
        sm::serialization::internal::HasIsBinaryEqual<sm::common::StripConstReference<decltype(t1cr)>::result_t>::value,
        1);
    ASSERT_EQ(
        sm::serialization::internal::HasIsBinaryEqual<sm::common::StripConstReference<decltype(t2cr)>::result_t>::value,
        0);
}
...
TEST(SerializationMacros, TestClassHasStreamOperator) {
    ...
    sm::serialization::internal::streamIf<
        sm::serialization::internal::HasOStreamOperator<std::ostream, decltype(e1)>::value, decltype(e1)>::eval(e1);
...
TEST(SerializationMacros, TestSharedPtrHasStreamOperator) {
    ...
    sm::serialization::internal::streamIf<sm::serialization::internal::HasOStreamOperator<std::ostream, T1>::value,
                                          T1>::eval(e1);
