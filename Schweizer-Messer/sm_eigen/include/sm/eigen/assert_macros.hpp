        ...
        for (int r = 0; r < matrix.rows(); ++r) {                                                                  \
            for (int c = 0; c < matrix.cols(); ++c) {                                                              \
                if (!std::isfinite(matrix(r, c))) {                                                                \
                    ...
                    sm_assert_stringstream << "debug assert( isfinite(" << #matrix << "(" << r << ", " << c        \
                                           << ") ) failed. [ isfinite(" << matrix(r, c) << " ) ]" << message       \
                                           << std::endl                                                            \
                                           << matrix;                                                              \
                    sm::detail::sm_throw_exception<exceptionType>("[" #exceptionType "] ", __FUNCTION__, __FILE__, \
                                                                  __LINE__, sm_assert_stringstream.str());         \
                }                                                                                                  \
            }                                                                                                      \
        }                                                                                                          \
    }
    ...
    {                                                                                                              \
        for (int r = 0; r < matrix.rows(); ++r) {                                                                  \
            for (int c = 0; c < matrix.cols(); ++c) {                                                              \
                if (!std::isfinite(matrix(r, c))) {                                                                \
                    std::stringstream sm_assert_stringstream;                                                      \
                    sm_assert_stringstream << "assert( isfinite(" << #matrix << "(" << r << ", " << c              \
                                           << ") ) failed. [ isfinite(" << matrix(r, c) << " ) ]" << message       \
                                           << std::endl                                                            \
                                           << matrix;                                                              \
                    sm::detail::sm_throw_exception<exceptionType>("[" #exceptionType "] ", __FUNCTION__, __FILE__, \
