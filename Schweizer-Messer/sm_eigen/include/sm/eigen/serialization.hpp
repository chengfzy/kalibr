...
inline void save(Archive& ar, const Eigen::Matrix<Scalar, A, B, C, D, E>& M, const unsigned int /* file_version */) {
...
///
template <class Archive, class Scalar, int A, int B, int C, int D, int E>
inline void load(Archive& ar, Eigen::Matrix<Scalar, A, B, C, D, E>& M, const unsigned int /* file_version */) {
    typedef typename Eigen::Matrix<Scalar, A, B, C, D, E>::Index index_t;
    index_t rows, cols;
    ar >> BOOST_SERIALIZATION_NVP(rows);
    ar >> BOOST_SERIALIZATION_NVP(cols);
...
inline void load(Archive& ar, Eigen::Matrix<Scalar, Eigen::Dynamic, B, C, D, E>& M,
...
inline void load(Archive& ar, Eigen::Matrix<Scalar, A, Eigen::Dynamic, C, D, E>& M,
                 const unsigned int /* file_version */) {
...
inline void load(Archive& ar, Eigen::Matrix<Scalar, Eigen::Dynamic, Eigen::Dynamic, C, D, E>& M,
                 const unsigned int /* file_version */) {
...
///
template <class Archive, class Scalar, int A, int B, int C, int D, int E>
inline void serialize(Archive& ar, Eigen::Matrix<Scalar, A, B, C, D, E>& M, const unsigned int file_version) {
...
inline void serialize(Archive& ar, Eigen::Transform<Scalar, Dim, Mode>& M, const unsigned int /* file_version */) {
