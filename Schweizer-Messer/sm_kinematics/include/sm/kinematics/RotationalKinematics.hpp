...
class RotationalKinematics {
  public:
    ...
    virtual Eigen::Matrix3d parametersToRotationMatrix(const Eigen::Vector3d& parameters,
                                                       Eigen::Matrix3d* S = NULL) const = 0;
    ...
    virtual Eigen::Vector3d angularVelocityAndJacobian(const Eigen::Vector3d& /* p */,
