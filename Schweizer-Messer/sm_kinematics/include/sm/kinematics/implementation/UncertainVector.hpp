...
template <int D>
sm::kinematics::UncertainVector<D> operator*(const typename sm::kinematics::UncertainVector<D>::linear_operator_t& M,
                                             const sm::kinematics::UncertainVector<D>& v) {
...
inline const UncertainVector<1>::value_t& UncertainVector<1>::v() const { return _v; }

/// \brief get the vector

inline const UncertainVector<1>::value_t& UncertainVector<1>::mean() const { return _v; }

/// \brief set the vector

inline void UncertainVector<1>::setMean(const value_t& v) { _v = v; }
...
inline const UncertainVector<1>::covariance_t& UncertainVector<1>::E() const { return _sigma2; }

/// \brief get the covariance

inline const UncertainVector<1>::covariance_t& UncertainVector<1>::covariance() const { return _sigma2; }

/// \brief set the covariance

inline void UncertainVector<1>::setCovariance(const covariance_t& E) { _sigma2 = E; }
...
inline UncertainVector<1> UncertainVector<1>::operator*(const UncertainVector<1>& rhs) const { return this->dot(rhs); }

inline UncertainVector<1> UncertainVector<1>::operator*(value_t rhs) const { return this->dot(rhs); }
