 ...
 * @return the 4x4 transformation matrix that is the best fit transformation \f$p_0 = \mathbf T_{0,1} p_1\f$ between the
 * two point sets.
 */
 ...
 *
 * @return the 3x3 transformation matrix that is the best fit rotation \f$p_0 = \mathbf C_{0,1} p_1\f$ between the two
 * point sets.
 */
