...
/**
 * Creates a transformation matrix \f$ \mathbf T_{ba} = \begin{bmatrix} \mathbf C_{ba} & \mathbf p_b^{ab} \\ \mathbf 0^T
 * & 1 \end{bmatrix}\f$ from the constituent parts
 *
 ...
 * @param out_B    Output: The jacobian of this transformation with respect to local perturbations of the transformation
 * matrix.
 */
...
// inline void transformationAndJacobian(Eigen::Matrix4d const & T_a_b, VEC1_T const & v_b, VEC2_T & out_v_a, MX_T &
// out_B)
// {
