...
Eigen::Matrix3d EulerAnglesYawPitchRoll::parametersToRotationMatrix(const Eigen::Vector3d& parameters,
...
Eigen::Vector3d EulerAnglesYawPitchRoll::angularVelocityAndJacobian(const Eigen::Vector3d& p,
