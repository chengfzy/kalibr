...
Eigen::Matrix3d EulerRodriguez::parametersToRotationMatrix(const Eigen::Vector3d& parameters,
...
Eigen::Vector3d EulerRodriguez::angularVelocityAndJacobian(const Eigen::Vector3d& p, const Eigen::Vector3d& pdot,
