...
UncertainTransformation::UncertainTransformation() : Transformation() { _U.setZero(); }

UncertainTransformation::UncertainTransformation(const Eigen::Matrix4d& T, const covariance_t& U)
    : Transformation(T), _U(U) {}

UncertainTransformation::UncertainTransformation(const Eigen::Matrix4d& T, double diagonalTranslationVariance,
...
UncertainTransformation::UncertainTransformation(const Transformation& T, double diagonalTranslationVariance,
                                                 double diagonalRotationVariance)
    : Transformation(T) {
    _U.setZero();
    _U(0, 0) = diagonalTranslationVariance;
...
UncertainTransformation::UncertainTransformation(const Transformation& T) : Transformation(T) { _U.setZero(); }

/// \brief Initialize with zero uncertainty
UncertainTransformation::UncertainTransformation(const Eigen::Matrix4d& T) : Transformation(T) { _U.setZero(); }
...
const UncertainTransformation::covariance_t& UncertainTransformation::U() const { return _U; }
...
void UncertainTransformation::setU(const covariance_t& U) { _U = U; }
...
Transformation UncertainTransformation::toTransformation() const { return *this; }
