...
class LoggingGlobals {
  public:
    ...
    void print(const char* streamName, Level level, const char* file, int line, const char* function, const char* fmt,
               ...) SMCONSOLE_PRINTF_ATTRIBUTE(7, 8);
    void print(const char* streamName, Level level, vectorstream& ss, const char* file, int line, const char* function);
