...
struct FixedToken : public Token {
    FixedToken(const std::string& str) : str_(str) {}
    virtual ~FixedToken() {}
    virtual std::string getString(const ::sm::logging::LoggingEvent&) { return str_.c_str(); }

    std::string str_;
};

struct FixedMapToken : public Token {
    FixedMapToken(const std::string& str, std::map<std::string, std::string>& smap) : str_(str), smap_(smap) {}
...
struct PlaceHolderToken : public Token {
    ...
    virtual std::string getString(const ::sm::logging::LoggingEvent&) { return "PLACEHOLDER"; }
};
...
struct StreamNameToken : public Token {
    ...
    virtual std::string getString(const ::sm::logging::LoggingEvent& event) { return event.streamName; }
};

struct TimeToken : public Token {
    virtual ~TimeToken() {}
    virtual std::string getString(const ::sm::logging::LoggingEvent& e) { return e.timestring; }
};
...
struct FileToken : public Token {
    virtual ~FileToken() {}
    virtual std::string getString(const ::sm::logging::LoggingEvent& event) { return event.file; }
};

struct FunctionToken : public Token {
    virtual ~FunctionToken() {}
    virtual std::string getString(const ::sm::logging::LoggingEvent& event) { return event.function; }
};
