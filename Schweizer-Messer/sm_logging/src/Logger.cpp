...
Logger::Time Logger::currentTime() const { return currentTimeImplementation(); }

void Logger::log(const LoggingEvent& event) { logImplementation(event); }

Logger::Time Logger::currentTimeImplementation() const { return Clock::now(); }
