...
double BoostPropertyTreeImplementation::getDouble(const std::string& key) const { return get<double>(key); }
...
int BoostPropertyTreeImplementation::getInt(const std::string& key) const { return get<int>(key); }
...
bool BoostPropertyTreeImplementation::getBool(const std::string& key) const { return get<bool>(key); }
...
std::string BoostPropertyTreeImplementation::getString(const std::string& key) const { return get<std::string>(key); }
...
bool BoostPropertyTreeImplementation::doesKeyExist(const std::string& key) const {
    boost::optional<std::string> val =
        _ptree.get<std::string>(boost::property_tree::ptree::path_type(key.c_str(), '/'));
...
void BoostPropertyTreeImplementation::setDouble(const std::string& key, double value) { set<double>(key, value); }

void BoostPropertyTreeImplementation::setInt(const std::string& key, int value) { set<int>(key, value); }

void BoostPropertyTreeImplementation::setBool(const std::string& key, bool value) { set<bool>(key, value); }

void BoostPropertyTreeImplementation::setString(const std::string& key, const std::string& value) {
    set<std::string>(key, value);
}

BoostPropertyTreeImplementation::iterator BoostPropertyTreeImplementation::begin() { return _ptree.begin(); }

BoostPropertyTreeImplementation::const_iterator BoostPropertyTreeImplementation::begin() const {
    return _ptree.begin();
}

BoostPropertyTreeImplementation::iterator BoostPropertyTreeImplementation::end() { return _ptree.end(); }

BoostPropertyTreeImplementation::const_iterator BoostPropertyTreeImplementation::end() const { return _ptree.end(); }
