...
struct Id_python_converter {
    ...
    static void* convertible(PyObject* obj_ptr) {
        if (!(PyInt_Check(obj_ptr) || PyLong_Check(obj_ptr))) return 0;
    ...
    static void construct(PyObject* obj_ptr, boost::python::converter::rvalue_from_python_stage1_data* data) {
        ...
        void* storage = ((boost::python::converter::rvalue_from_python_storage<id_t>*)data)->storage.bytes;
    ...
    static void register_converter() {
        ...
        if (reg == NULL || reg->m_to_python == NULL) {
            ...
            boost::python::converter::registry::push_back(&convertible, &construct, boost::python::type_id<id_t>());
        }
    }
};
