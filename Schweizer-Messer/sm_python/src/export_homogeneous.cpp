...
Eigen::Vector4d toHomogeneousWrap(const Eigen::Vector3d& v) { return sm::kinematics::toHomogeneous(v); }

Eigen::Vector3d fromHomogeneousWrap(const Eigen::Vector4d& v) { return sm::kinematics::fromHomogeneous(v); }
