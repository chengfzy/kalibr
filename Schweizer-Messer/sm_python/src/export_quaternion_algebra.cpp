...
void export_quaternion_algebra() {
    ...
    def("axisAngle2quat", axisAngle2quat,
        "Build a quaternion from a axis/angle representation (the input is the unit-length axis times the angle of "
        "rotation about that axis)");
    // Eigen::Vector3d quat2AxisAngle<double>(Eigen::Vector4d const & q);
    def("quat2AxisAngle", quat2AxisAngle<double>,
        "Build an axis angle from a quaternion. The output is the unit-length axis times the angle of rotation about "
        "that axis");
