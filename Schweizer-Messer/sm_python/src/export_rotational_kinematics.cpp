...
template <typename ROTATION_TYPE>
boost::python::tuple angularVelocityAndJacobianWrapper(const ROTATION_TYPE* rt, const Eigen::Vector3d& p,
...
void import_rotational_kinematics_python() {
    ...
    RotationalKinematicsPythonWrapper<sm::kinematics::EulerAnglesYawPitchRoll>::exportToPython(
