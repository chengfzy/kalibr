...
class Random {
  public:
    ...
    double normal() { return _normal(); }

    double uniform() { return _uniform(); }
...
double normal() { return Random::instance().normal(); }

double randn() { return Random::instance().normal(); }

double uniform() { return Random::instance().uniform(); }

double rand() { return Random::instance().uniform(); }
...
void seed(boost::uint64_t s) { Random::instance().seed(s); }
