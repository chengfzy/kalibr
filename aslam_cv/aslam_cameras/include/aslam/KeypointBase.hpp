...
class KeypointBase {
  public:
    ...
    virtual Eigen::VectorXd vsY() const { return vsMeasurement(); }
    ...
    virtual Eigen::MatrixXd vsInvR() const { return vsInverseMeasurementCovariance(); }
    virtual void vsSetInverseMeasurementCovariance(const Eigen::MatrixXd& invR) = 0;
    ...
    /// \brief set the keypoint descriptor
    ///        the keypoint takes ownership of the pointer
    virtual void setDescriptorPtr(boost::shared_ptr<DescriptorBase> descriptor) = 0;
    ...
    virtual void setLandmark(const sm::kinematics::UncertainHomogeneousPoint& landmark) = 0;
    ...
    virtual void setBackProjection(const sm::kinematics::UncertainVector3& v) = 0;
