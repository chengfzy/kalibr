...
class DoubleSphereProjection {
  public:
    ...
    DoubleSphereProjection(double xi, double alpha, double focalLengthU, double focalLengthV, double imageCenterU,
    ...
    bool isProjectionInvertible() const { return true; }
