...
class ExtendedUnifiedProjection {
  public:
    ...
    ExtendedUnifiedProjection(double alpha, double beta, double focalLengthU, double focalLengthV, double imageCenterU,
                              double imageCenterV, int resolutionU, int resolutionV, distortion_t distortion);
    ...
    double alpha() const { return _alpha; }  /// \brief the beta parameter that controls the ellipsoid shape.
