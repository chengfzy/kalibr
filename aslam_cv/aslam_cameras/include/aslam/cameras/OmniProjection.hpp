...
class OmniProjection {
  public:
    ...
    OmniProjection(double xi, double focalLengthU, double focalLengthV, double imageCenterU, double imageCenterV,
  ...
  private:
    ...
    double
        _fov_parameter;  // PM: is = xi for xi=<1, = 1/xi for x>1. Used for determining valid projections. Better name?
