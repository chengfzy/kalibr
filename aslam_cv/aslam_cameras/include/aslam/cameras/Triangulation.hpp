...
void triangulate(const Eigen::Vector3d& point0, const Eigen::Vector3d& ray0, const Eigen::Vector3d& point1,
                 const Eigen::Vector3d& ray1, Eigen::Vector3d& outTriangulatedPoint, double& outGap, double& outS0,
                 double& outS1);
}  // namespace cameras
}  // namespace aslam
