...
template <typename DISTORTION_T>
DepthProjection<DISTORTION_T>::DepthProjection(double focalLengthU, double focalLengthV, double imageCenterU,
...
template <typename DISTORTION_T>
Eigen::Vector3d DepthProjection<DISTORTION_T>::createRandomVisiblePoint(double /* depth */) const {
    /// \todo
