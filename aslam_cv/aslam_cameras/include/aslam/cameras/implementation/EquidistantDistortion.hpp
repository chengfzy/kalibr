...
void EquidistantDistortion::distort(const Eigen::MatrixBase<DERIVED_Y> &yconst,
    ...
    J(0, 0) = atan(sqrt(y[0] * y[0] + y[1] * y[1])) * 1.0 / sqrt(y[0] * y[0] + y[1] * y[1]) *
              ...
              y[0] * atan(sqrt(y[0] * y[0] + y[1] * y[1])) * 1.0 / sqrt(y[0] * y[0] + y[1] * y[1]) *
                  ((_k2 * y[0] * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 3.0) * 1.0 /
                   ...
                   (_k4 * y[0] * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 7.0) * 1.0 /
                    sqrt(y[0] * y[0] + y[1] * y[1]) * 8.0) /
                       (y[0] * y[0] + y[1] * y[1] + 1.0) +
                   (_k1 * y[0] * atan(sqrt(y[0] * y[0] + y[1] * y[1])) * 1.0 / sqrt(y[0] * y[0] + y[1] * y[1]) * 2.0) /
                       (y[0] * y[0] + y[1] * y[1] + 1.0)) +
              ((y[0] * y[0]) * (_k1 * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 2.0) +
                                _k2 * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 4.0) +
                                _k3 * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 6.0) +
                                _k4 * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 8.0) + 1.0)) /
                  ((y[0] * y[0] + y[1] * y[1]) * (y[0] * y[0] + y[1] * y[1] + 1.0)) -
              (y[0] * y[0]) * atan(sqrt(y[0] * y[0] + y[1] * y[1])) * 1.0 / pow(y[0] * y[0] + y[1] * y[1], 3.0 / 2.0) *
                  (_k1 * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 2.0) +
                   _k2 * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 4.0) +
                   _k3 * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 6.0) +
                   _k4 * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 8.0) + 1.0);
    J(0, 1) = y[0] * atan(sqrt(y[0] * y[0] + y[1] * y[1])) * 1.0 / sqrt(y[0] * y[0] + y[1] * y[1]) *
                  ((_k2 * y[1] * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 3.0) * 1.0 /
                   ...
                   (_k4 * y[1] * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 7.0) * 1.0 /
                    sqrt(y[0] * y[0] + y[1] * y[1]) * 8.0) /
                       (y[0] * y[0] + y[1] * y[1] + 1.0) +
                   (_k1 * y[1] * atan(sqrt(y[0] * y[0] + y[1] * y[1])) * 1.0 / sqrt(y[0] * y[0] + y[1] * y[1]) * 2.0) /
                       (y[0] * y[0] + y[1] * y[1] + 1.0)) +
              (y[0] * y[1] *
               (_k1 * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 2.0) +
                _k2 * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 4.0) +
                ...
                _k4 * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 8.0) + 1.0)) /
                  ((y[0] * y[0] + y[1] * y[1]) * (y[0] * y[0] + y[1] * y[1] + 1.0)) -
              y[0] * y[1] * atan(sqrt(y[0] * y[0] + y[1] * y[1])) * 1.0 / pow(y[0] * y[0] + y[1] * y[1], 3.0 / 2.0) *
                  (_k1 * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 2.0) +
                   _k2 * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 4.0) +
                   _k3 * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 6.0) +
                   _k4 * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 8.0) + 1.0);
    J(1, 0) = y[1] * atan(sqrt(y[0] * y[0] + y[1] * y[1])) * 1.0 / sqrt(y[0] * y[0] + y[1] * y[1]) *
                  ((_k2 * y[0] * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 3.0) * 1.0 /
                    sqrt(y[0] * y[0] + y[1] * y[1]) * 4.0) /
                       (y[0] * y[0] + y[1] * y[1] + 1.0) +
                   (_k3 * y[0] * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 5.0) * 1.0 /
              ...
              y[0] * y[1] * atan(sqrt(y[0] * y[0] + y[1] * y[1])) * 1.0 / pow(y[0] * y[0] + y[1] * y[1], 3.0 / 2.0) *
                  (_k1 * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 2.0) +
                   ...
                   _k3 * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 6.0) +
                   _k4 * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 8.0) + 1.0);
    J(1, 1) = atan(sqrt(y[0] * y[0] + y[1] * y[1])) * 1.0 / sqrt(y[0] * y[0] + y[1] * y[1]) *
                  (_k1 * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 2.0) +
                   _k2 * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 4.0) +
                   _k3 * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 6.0) +
                   _k4 * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 8.0) + 1.0) +
              y[1] * atan(sqrt(y[0] * y[0] + y[1] * y[1])) * 1.0 / sqrt(y[0] * y[0] + y[1] * y[1]) *
                  ((_k2 * y[1] * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 3.0) * 1.0 /
                    sqrt(y[0] * y[0] + y[1] * y[1]) * 4.0) /
                       (y[0] * y[0] + y[1] * y[1] + 1.0) +
                   (_k3 * y[1] * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 5.0) * 1.0 /
                   ...
                   (_k1 * y[1] * atan(sqrt(y[0] * y[0] + y[1] * y[1])) * 1.0 / sqrt(y[0] * y[0] + y[1] * y[1]) * 2.0) /
                       (y[0] * y[0] + y[1] * y[1] + 1.0)) +
              ((y[1] * y[1]) * (_k1 * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 2.0) +
                                _k2 * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 4.0) +
                                _k3 * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 6.0) +
                                _k4 * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 8.0) + 1.0)) /
                  ((y[0] * y[0] + y[1] * y[1]) * (y[0] * y[0] + y[1] * y[1] + 1.0)) -
              (y[1] * y[1]) * atan(sqrt(y[0] * y[0] + y[1] * y[1])) * 1.0 / pow(y[0] * y[0] + y[1] * y[1], 3.0 / 2.0) *
                  (_k1 * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 2.0) +
                   _k2 * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 4.0) +
                   _k3 * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 6.0) +
                   _k4 * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 8.0) + 1.0);
...
void EquidistantDistortion::undistort(const Eigen::MatrixBase<DERIVED> &yconst) const {
    ...
    for (int i = 20; i > 0; i--) {
        ...
        theta6 = theta4 * theta2;
        theta8 = theta4 * theta4;
        theta = thetad / (1 + _k1 * theta2 + _k2 * theta4 + _k3 * theta6 + _k4 * theta8);
    }
...
void EquidistantDistortion::undistort(const Eigen::MatrixBase<DERIVED> &yconst,
                                      const Eigen::MatrixBase<DERIVED_JY> &outJy) const {
    EIGEN_STATIC_ASSERT_VECTOR_SPECIFIC_SIZE_OR_DYNAMIC(Eigen::MatrixBase<DERIVED>, 2);
    EIGEN_STATIC_ASSERT_MATRIX_SPECIFIC_SIZE_OR_DYNAMIC(Eigen::MatrixBase<DERIVED_JY>, 2, 2);
...
void EquidistantDistortion::distortParameterJacobian(const Eigen::MatrixBase<DERIVED_Y> &y,
    ...
    J(0, 0) = y[0] * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 3.0) * 1.0 / sqrt(y[0] * y[0] + y[1] * y[1]);
    J(0, 1) = y[0] * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 5.0) * 1.0 / sqrt(y[0] * y[0] + y[1] * y[1]);
    J(0, 2) = y[0] * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 7.0) * 1.0 / sqrt(y[0] * y[0] + y[1] * y[1]);
    J(0, 3) = y[0] * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 9.0) * 1.0 / sqrt(y[0] * y[0] + y[1] * y[1]);
    J(1, 0) = y[1] * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 3.0) * 1.0 / sqrt(y[0] * y[0] + y[1] * y[1]);
    J(1, 1) = y[1] * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 5.0) * 1.0 / sqrt(y[0] * y[0] + y[1] * y[1]);
    J(1, 2) = y[1] * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 7.0) * 1.0 / sqrt(y[0] * y[0] + y[1] * y[1]);
    J(1, 3) = y[1] * pow(atan(sqrt(y[0] * y[0] + y[1] * y[1])), 9.0) * 1.0 / sqrt(y[0] * y[0] + y[1] * y[1]);
...
template <class Archive>
void EquidistantDistortion::save(Archive &ar, const unsigned int /* version */) const {
    ar << BOOST_SERIALIZATION_NVP(_k1);
    ar << BOOST_SERIALIZATION_NVP(_k2);
    ar << BOOST_SERIALIZATION_NVP(_k3);
    ar << BOOST_SERIALIZATION_NVP(_k4);
