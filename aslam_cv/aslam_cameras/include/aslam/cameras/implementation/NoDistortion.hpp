...
void NoDistortion::distort(const Eigen::MatrixBase<DERIVED_Y> & /* y */,
    ...
    Eigen::MatrixBase<DERIVED_JY> &outJy = const_cast<Eigen::MatrixBase<DERIVED_JY> &>(outJyConst);
...
void NoDistortion::undistort(const Eigen::MatrixBase<DERIVED> & /* y */,
                             const Eigen::MatrixBase<DERIVED_JY> &outJyConst) const {
    EIGEN_STATIC_ASSERT_VECTOR_SPECIFIC_SIZE_OR_DYNAMIC(Eigen::MatrixBase<DERIVED>, 2);
    EIGEN_STATIC_ASSERT_MATRIX_SPECIFIC_SIZE_OR_DYNAMIC(Eigen::MatrixBase<DERIVED_JY>, 2, 2);
    Eigen::MatrixBase<DERIVED_JY> &outJy = const_cast<Eigen::MatrixBase<DERIVED_JY> &>(outJyConst);
...
void NoDistortion::distortParameterJacobian(const Eigen::MatrixBase<DERIVED_Y> & /* imageY */,
    ...
    Eigen::MatrixBase<DERIVED_JD> &outJd = const_cast<Eigen::MatrixBase<DERIVED_JD> &>(outJdConst);
