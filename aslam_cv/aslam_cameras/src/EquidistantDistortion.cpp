...
EquidistantDistortion::EquidistantDistortion() : _k1(0), _k2(0), _k3(0), _k4(0) {}

EquidistantDistortion::EquidistantDistortion(double k1, double k2, double k3, double k4)
...
int EquidistantDistortion::minimalDimensions() const { return IntrinsicsDimension; }
...
Eigen::Vector2i EquidistantDistortion::parameterSize() const { return Eigen::Vector2i(4, 1); }

bool EquidistantDistortion::isBinaryEqual(const EquidistantDistortion& rhs) const {
    return SM_CHECKMEMBERSSAME(rhs, _k1) && SM_CHECKMEMBERSSAME(rhs, _k2) && SM_CHECKMEMBERSSAME(rhs, _k3) &&
           SM_CHECKMEMBERSSAME(rhs, _k4);
}
