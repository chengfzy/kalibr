...
FovDistortion::FovDistortion() : _w(1.0) {
...
Eigen::Vector2i FovDistortion::parameterSize() const { return Eigen::Vector2i(1, 1); }

bool FovDistortion::isBinaryEqual(const FovDistortion& rhs) const { return SM_CHECKMEMBERSSAME(rhs, _w); }

FovDistortion FovDistortion::getTestDistortion() { return FovDistortion(1.0); }
