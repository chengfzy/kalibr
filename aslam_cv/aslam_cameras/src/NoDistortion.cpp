...
int NoDistortion::minimalDimensions() const { return 0; }
void NoDistortion::getParameters(Eigen::MatrixXd& P) const { P.resize(0, 0); }
void NoDistortion::setParameters(const Eigen::MatrixXd& /* P */) {}

Eigen::Vector2i NoDistortion::parameterSize() const { return Eigen::Vector2i(0, 0); }
