...
PinholeCameraGeometry::PinholeCameraGeometry() { *this = createTestGeometry(); }

PinholeCameraGeometry::PinholeCameraGeometry(double focalLengthU, double focalLengthV, double imageCenterU,
...
PinholeCameraGeometry::PinholeCameraGeometry(double focalLengthU, double focalLengthV, double imageCenterU,
                                             double imageCenterV, int resolutionU, int resolutionV, double k1,
...
PinholeCameraGeometry::keypoint_t PinholeCameraGeometry::minKeypoint() const { return keypoint_t(0, 0); }

std::string PinholeCameraGeometry::typeName() const { return "PinholeCamera"; }
