...
PinholeRSCameraGeometry::PinholeRSCameraGeometry() { *this = createTestGeometry(); }

PinholeRSCameraGeometry::PinholeRSCameraGeometry(double focalLengthU, double focalLengthV, double imageCenterU,
...
PinholeRSCameraGeometry::PinholeRSCameraGeometry(double focalLengthU, double focalLengthV, double imageCenterU,
                                                 double imageCenterV, int resolutionU, int resolutionV,
                                                 double lineDelay, double k1, double k2, double p1, double p2)
    : _fu(focalLengthU),
      _fv(focalLengthV),
      _cu(imageCenterU),
      _cv(imageCenterV),
...
Duration PinholeRSCameraGeometry::temporalOffset(const keypoint_t &keypoint) const {
    // time offset only depends on the line => keypoint(1)
    return Duration(_lineDelay * keypoint(1));
}

PinholeRSCameraGeometry::keypoint_t PinholeRSCameraGeometry::maxKeypoint() const { return keypoint_t(_ru, _rv); }

PinholeRSCameraGeometry::keypoint_t PinholeRSCameraGeometry::minKeypoint() const { return keypoint_t(0, 0); }

std::string PinholeRSCameraGeometry::typeName() const { return "PinholeRSCamera"; }
...
PinholeRSCameraGeometry PinholeRSCameraGeometry::createDistortedTestGeometry() {
    return PinholeRSCameraGeometry(400, 400, 320, 240, 640, 480, 0.0005, 0.2, 0.2, 0.2, 0.2);
}
 ...
 */
void PinholeRSCameraGeometry::distortion(double mx_u, double my_u, double *dx_u, double *dy_u) const {
 ...
 * \param dy return value, to obtain the distorted point : my_d = my_u+dy_u
 */
void PinholeRSCameraGeometry::distortion(double mx_u, double my_u, double *dx_u, double *dy_u, double *dxdmx,
...
void PinholeRSCameraGeometry::undistortGN(double u_d, double v_d, double *u, double *v) const {
    *u = u_d;
    *v = v_d;
