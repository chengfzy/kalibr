...
SphericalCameraGeometry::SphericalCameraGeometry() { *this = createTestGeometry(); }

SphericalCameraGeometry::SphericalCameraGeometry(double xi, double gamma1, double gamma2, double u0, double v0,
                                                 int width, int height)
    : _xi(xi), _gamma1(gamma1), _gamma2(gamma2), _u0(u0), _v0(v0), _width(width), _height(height) {
    updateTemporaries();
}
...
SphericalCameraGeometry::keypoint_t SphericalCameraGeometry::minKeypoint() const { return keypoint_t(0, 0); }

std::string SphericalCameraGeometry::typeName() const { return "SphericalCamera"; }

SphericalCameraGeometry SphericalCameraGeometry::createTestGeometry() {
    return SphericalCameraGeometry(1.2080, 5.671146836756682e+02, 5.665554204210736e+02, 6.196542975873804e+02,
