...
TEST(GridCalibrationTestSuite, testSerialization) {
    ...
    try {
        ...
        GridCalibrationTargetCheckerboard::Ptr checker(
            new GridCalibrationTargetCheckerboard(8, 9, 1, 1, checkeroptions));
...
TEST(GridCalibrationTestSuite, testCalibrationTargetCheckerboard) {
    ...
    try {
        ...
        GridCalibrationTargetCheckerboard::Ptr target(
            new GridCalibrationTargetCheckerboard(rows, cols, rowSpacingMeters, colSpacingMeter, target_options));
...
TEST(GridCalibrationTestSuite, testCalibrationTargetCircleGrid) {
    ...
    try {
        ...
        GridCalibrationTargetCirclegrid::Ptr target(
            new GridCalibrationTargetCirclegrid(rows, cols, spacingMeters, target_options));
