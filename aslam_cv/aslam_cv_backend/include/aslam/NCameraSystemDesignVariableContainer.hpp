...
class NCameraSystemDesignVariableContainer {
  public:
    ...
    NCameraSystemDesignVariableContainer(NCameraSystem::Ptr cameraSystem, bool estimateExtrinsicsRotation,
    ...
    boost::shared_ptr<ReprojectionError> createReprojectionError(MultiFrame& mf, const KeypointIdentifier& kid,
