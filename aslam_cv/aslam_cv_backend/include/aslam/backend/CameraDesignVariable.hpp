...
class CameraDesignVariable : public boost::enable_shared_from_this<CameraDesignVariable<CAMERA_T> > {
  public:
    ...
    void evaluateJacobians(JacobianContainer& outJacobians, const Eigen::MatrixXd& applyChainRule,
    ...
    void setTestBlockIndices() {
        _projectionDv->setBlockIndex(0);
        _distortionDv->setBlockIndex(1);
        _shutterDv->setBlockIndex(2);
    };
