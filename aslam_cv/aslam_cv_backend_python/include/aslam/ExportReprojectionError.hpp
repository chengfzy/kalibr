...
void exportReprojectionError(const std::string &camName) {
    ...
    class_<ReprojectionError<geometry_t>, boost::shared_ptr<ReprojectionError<geometry_t> >, bases<ErrorTerm> >(
        ...
        .def(init<typename ReprojectionError<geometry_t>::measurement_t,
            ...
            (name + "( y, invR, homogeneousPointExpression, CameraDesignVariable)").c_str()))
        .def("updateMeasurement", &ReprojectionError<geometry_t>::updateMeasurement)
        .def("updateMeasurementAndCovariance", &ReprojectionError<geometry_t>::updateMeasurementAndCovariance)
        .def("getMeasurement", &ReprojectionError<geometry_t>::getMeasurement)
