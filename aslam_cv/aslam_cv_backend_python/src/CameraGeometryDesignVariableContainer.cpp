...
void exportCameraGeometryDvc() {
    ...
    class_<CameraGeometryDesignVariableContainer, boost::shared_ptr<CameraGeometryDesignVariableContainer>,
        ...
        .def("temporalOffset", &CameraGeometryDesignVariableContainer::temporalOffset,
             "ScalarExpression temporalOffset( keypointMeasurement)")

        .def("createReprojectionError", &CameraGeometryDesignVariableContainer::createReprojectionError,
             "reprojectionError createReprojectionError( y, invR, p_c )")

        .def("setActive", &CameraGeometryDesignVariableContainer::setActive)

        .def("isActive", &CameraGeometryDesignVariableContainer::isActive)
        .def("isProjectionActive", &CameraGeometryDesignVariableContainer::isProjectionActive)
        .def("isDistortionActive", &CameraGeometryDesignVariableContainer::isDistortionActive)
        .def("isShutterActive", &CameraGeometryDesignVariableContainer::isShutterActive)
        .def("camera", &CameraGeometryDesignVariableContainer::camera)
        .def("getDesignVariable", &CameraGeometryDesignVariableContainer::getDesignVariable)
        .def("getDesignVariables", &getDesignVariablesWrap<CameraGeometryDesignVariableContainer>)
    ...
    class_<ReprojectionError, boost::shared_ptr<ReprojectionError>, bases<aslam::backend::ErrorTerm>,
        ...
        .def("getPoint", &ReprojectionError::getPoint)
        .def("isEnabled", &ReprojectionError::isEnabled)
        .def("getProjection", &ReprojectionError::getProjection)
        .def("getProjectionSuccess", &ReprojectionError::getProjectionSuccess);
}
