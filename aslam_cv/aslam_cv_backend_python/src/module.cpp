...
BOOST_PYTHON_MODULE(libaslam_cv_backend_python) {
    ...
    aslam::python::exportReprojectionErrors<EquidistantDistortedPinholeRsCameraGeometry>(
        "EquidistantDistortedPinholeRs");
    aslam::python::exportCovarianceReprojectionError<EquidistantDistortedPinholeRsCameraGeometry>(
        "EquidistantDistortedPinholeRs");
    ...
    aslam::python::exportCovarianceReprojectionError<EquidistantDistortedOmniRsCameraGeometry>(
        "EquidistantDistortedOmniRs");
    ...
    exportCameraDesignVariables<EquidistantDistortedPinholeRsCameraGeometry>(
    ...
    exportCameraDesignVariables<MaskedEquidistantDistortedPinholeCameraGeometry>(
    ...
    exportCameraDesignVariables<MaskedEquidistantDistortedPinholeRsCameraGeometry>(
    ...
    exportCameraDesignVariables<MaskedEquidistantDistortedOmniRsCameraGeometry>(
    ...
    exportCameraDesignVariables<MaskedEquidistantDistortedOmniCameraGeometry>(
    ...
    exportGenericProjectionDesignVariable<PinholeProjection<EquidistantDistortion> >(
        "EquidistantDistortedPinholeProjection");
