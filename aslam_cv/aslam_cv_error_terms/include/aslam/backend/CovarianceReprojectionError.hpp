...
class CovarianceReprojectionError : public ErrorTermFs<FRAME_T::KeypointDimension> {
  public:
    ...
    CovarianceReprojectionError(const frame_t* frame, int keypointIndex, const HomogeneousExpression& point,
                                CameraDesignVariable<camera_geometry_t> camera, spline_t* spline = NULL);
