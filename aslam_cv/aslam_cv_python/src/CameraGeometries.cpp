...
boost::python::tuple triangulateWrap(const Eigen::Vector3d& point0, const Eigen::Vector3d& ray0,
                                     const Eigen::Vector3d& point1, const Eigen::Vector3d& ray1) {
    Eigen::Vector3d outTriangulatedPoint;
    double outGap;
    double outS0;
    double outS1;
    triangulate(point0, ray0, point1, ray1, outTriangulatedPoint, outGap, outS0, outS1);
...
void exportCameraGeometry(std::string name) {
    ...
    boost::python::class_<C, boost::shared_ptr<C>, boost::python::bases<CameraGeometryBase> >(name.c_str(),
                                                                                              boost::python::init<>())
...
void exportCameraGeometries() {
    ...
    exportCameraGeometry<FovDistortedPinholeCameraGeometry>("FovDistortedPinholeCameraGeometry");
    ...
    exportCameraGeometry<FovDistortedPinholeRsCameraGeometry>("FovDistortedPinholeRsCameraGeometry");
    ...
    exportCameraGeometry<FovDistortedOmniRsCameraGeometry>("FovDistortedOmniRsCameraGeometry");
    ...
    exportCameraGeometry<FovDistortedOmniCameraGeometry>("FovDistortedOmniCameraGeometry");
    ...
    exportCameraGeometry<MaskedFovDistortedPinholeCameraGeometry>("MaskedFovDistortedPinholeCameraGeometry");
    ...
    exportCameraGeometry<MaskedFovDistortedPinholeRsCameraGeometry>("MaskedFovDistortedPinholeRsCameraGeometry");
    ...
    exportCameraGeometry<MaskedFovDistortedOmniRsCameraGeometry>("MaskedFovDistortedOmniRsCameraGeometry");
    ...
    exportCameraGeometry<MaskedFovDistortedOmniCameraGeometry>("MaskedFovDistortedOmniCameraGeometry");
    ...
    exportCameraGeometry<FovDistortedDepthCameraGeometry>("FovDistortedDepthCameraGeometry");
    ...
    class_<NoMask, boost::shared_ptr<NoMask> >("NoMask", init<>()).def("isValid", &NoMask::isValid<Eigen::VectorXd>);
