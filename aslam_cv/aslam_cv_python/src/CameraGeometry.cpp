...
void exportCameraGeometryBase() {
    ...
    boost::python::class_<aslam::cameras::CameraGeometryBase, boost::shared_ptr<aslam::cameras::CameraGeometryBase>,
                          boost::noncopyable>("CameraGeometryBase", boost::python::no_init)
        .def("keypointDimension", &CameraGeometryBase::keypointDimension, "Get the dimension of the keypoint type")
        .def("isProjectionInvertible", &CameraGeometryBase::isProjectionInvertible,
             "Is the sensor model invertible? Ususally this is only true for a range/bearing sensor.")
        .def("temporalOffset", &CameraGeometryBase::vsTemporalOffset,
             "Given a keypoint, what is the offset from the start of integration for this image?\nDuration = "
             "temporalOffset(keypoint)")
        .def("createRandomKeypoint", &CameraGeometryBase::createRandomKeypoint,
             "Create a valid, random keypoint. This is useful for unit testing and experiments.")
        .def("createRandomVisiblePoint", &CameraGeometryBase::createRandomVisiblePoint,
             "Create a valid point in space visible by the camera.\np = createRandomVisiblePoint(depth).")
        .def("euclideanToKeypoint", &detail::e2k<CameraGeometryBase>,
             "Map a 3x1 Euclidean point to a keypoint.\nk = euclideanToKeypoint(p)")
        .def("euclideanToKeypointJp", &detail::e2kJp<CameraGeometryBase>,
        ...
        .def("homogeneousToKeypoint", &detail::eh2k<CameraGeometryBase>,
             "Map a 4x1 homogeneous Euclidean point to a keypoint.\nk = euclideanToKeypoint(p)")
        .def("homogeneousToKeypointJp", &detail::eh2kJp<CameraGeometryBase>,
        ...
        .def("keypointToHomogeneous", &detail::k2eh<CameraGeometryBase>,
             "Map a keypoint to a 4x1 homogeneous Euclidean point.\np = keypointToHomogeneous(k)")
        .def("keypointToHomogeneousJk", &detail::k2ehJk<CameraGeometryBase>,
        ...
        .def("keypointToEuclidean", &detail::k2e<CameraGeometryBase>,
             "Map a keypoint to a 3x1 Euclidean point.\np = keypointToEuclidean(k)")
        .def("keypointToEuclideanJk", &detail::k2eJk<CameraGeometryBase>,
        ...
        .def("estimateTransformation", &detail::estimateTransformation<CameraGeometryBase>,
             "estimate the transformation of the camera with respect to the calibration target, returns tuple (bool, "
             "sm.Transformation)")
        .def("initializeIntrinsics", &detail::initializeIntrinsics<CameraGeometryBase>,
             "intialize intrinsics on a list of observations")
