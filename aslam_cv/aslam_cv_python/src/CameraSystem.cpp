...
void exportCameraSystem() {
    ...
    class_<CameraSystemBase, boost::shared_ptr<CameraSystemBase>, boost::noncopyable>("CameraSystemBase", no_init)
        ...
        .def("T_v_c", &CameraSystemBase::T_v_c, return_value_policy<copy_const_reference>())
        ...
        //     virtual const aslam::cameras::ImageMask * getOverlap(size_t cameraIndexSeenBy, size_t cameraIndex) const
        //     = 0;
        .def("getOverlap", &CameraSystemBase::getOverlap, return_internal_reference<>())
        //     virtual bool hasOverlap(size_t cameraIndexSeenBy, size_t cameraIndex) const = 0;
        .def("hasOverlap", &CameraSystemBase::hasOverlap)
        .def("id", &CameraSystemBase::id)
        .def("setId", &CameraSystemBase::setId);
