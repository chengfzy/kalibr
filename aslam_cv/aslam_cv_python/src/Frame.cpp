...
void exportFrame() {
    ...
    class_<KeypointBase, boost::shared_ptr<KeypointBase>, boost::noncopyable>("KeypointBase", no_init)
        .def("landmark", &KeypointBase::landmark, return_value_policy<return_by_value>())
        ...
        .def("descriptor", &KeypointBase::descriptorPtr)
        .def("setDescriptor", &KeypointBase::setDescriptorPtr)
        .def("clearLandmark", &KeypointBase::clearLandmark)
        .def("setBackProjection", &KeypointBase::setBackProjection)
        .def("setBackProjectionVector", &KeypointBase::setBackProjectionVector)
        .def("backProjection", &KeypointBase::backProjection, return_value_policy<return_by_value>())
        .def("isBackProjectionSet", &KeypointBase::isBackProjectionSet)
    ...
    /// \brief get the back projection for keypoint i
    void (FrameBase::*getUncertainBackProjection1)(size_t i, UncertainBackProjection & outBackProjection) const =
    ...
    class_<FrameBase, boost::shared_ptr<FrameBase>, boost::noncopyable>("FrameBase", no_init)
        ...
        .def("computeAllBackProjections", &FrameBase::computeAllBackProjections)
        .def("clearKeypoints", &FrameBase::clearKeypoints)
        //.def("",&FrameBase::)
    ...
    aslam::python::exportFrame<DistortedPinholeCameraGeometry>("DistortedPinholeFrame");
    aslam::python::exportFrame<EquidistantDistortedPinholeCameraGeometry>("EquidistantDistortedPinholeFrame");
    aslam::python::exportFrame<FovDistortedPinholeCameraGeometry>("FovDistortedPinholeFrame");

    aslam::python::exportFrame<PinholeRsCameraGeometry>("PinholeRsFrame");
    aslam::python::exportFrame<DistortedPinholeRsCameraGeometry>("DistortedPinholeRsFrame");
    aslam::python::exportFrame<EquidistantDistortedPinholeRsCameraGeometry>("EquidistantPinholeRsFrame");
    ...
    aslam::python::exportFrame<MaskedDistortedOmniCameraGeometry>("MaskedDistortedOmniFrame");

    aslam::python::exportKeypoint<2>();
    aslam::python::exportKeypoint<3>();
    aslam::python::exportKeypoint<4>();

    class_<KeypointIdentifier>("KeypointIdentifier", init<>())
        .def(init<MultiFrameId, size_t, size_t>())
        .add_property("frameId", &KeypointIdentifier::getFrameId, &KeypointIdentifier::setFrameId)
        .def_readwrite("keypointIndex", &KeypointIdentifier::keypointIndex)
        .def_readwrite("cameraIndex", &KeypointIdentifier::cameraIndex);
    // export the optimizable intrinsics errors
    // aslam::python::exportReprojectionIntrinsicsError<PinholeRsCameraDesignVariable,
    // SurfDescriptor>("PinholeRsDVSurfFrameReprojectionIntrinsicsError");
    // aslam::python::exportReprojectionIntrinsicsError<PinholeRsCameraDesignVariable,
    // BriskDescriptor>("PinholeRsDVBriskFrameReprojectionIntrinsicsError");
    // aslam::python::exportReprojectionIntrinsicsError<PinholeCameraDesignVariable,
    // SurfDescriptor>("PinholeDVSurfFrameReprojectionIntrinsicsError");
    // aslam::python::exportReprojectionIntrinsicsError<PinholeCameraDesignVariable,
    ...
    class_<BackProjection, boost::shared_ptr<BackProjection> >("BackProjection", init<>())
        ...
        .def("setViewOrigin", &BackProjection::setViewOrigin);
}
