...
class PythonImageList {
  public:
    ...
    ImageListTypePtr getImages() { return _images; }
...
Eigen::VectorXi getCornersIdx(aslam::cameras::GridCalibrationTargetObservation* frame) {
    ...
    for (unsigned int i = 0; i < numCorners; i++) imageCornersEigen(i) = cornersIdx[i];
...
void exportGridCalibration() {
    ...
    class_<PythonImageList>("NumpyImageList", init<>()).def("addImage", &addImageToList);
    ...
    class_<GridDetector, boost::shared_ptr<GridDetector>, boost::noncopyable>(
        "GridDetector",
        init<boost::shared_ptr<CameraGeometryBase>, GridCalibrationTargetBase::Ptr, GridDetector::GridDetectorOptions>(
            "GridDetector::GridDetector( boost::shared_ptr<CameraGeometryBase> geometry, "
            "GridCalibrationTargetBase::Ptr target, GridDetector::GridDetectorOptions options)"))
        ...
        .def(init<boost::shared_ptr<CameraGeometryBase>, GridCalibrationTargetBase::Ptr>(
            "GridDetector::GridDetector( boost::shared_ptr<CameraGeometryBase> geometry, "
    ...
    class_<GridCalibrationTargetBase, boost::shared_ptr<GridCalibrationTargetBase>, boost::noncopyable>(
        "GridCalibrationTargetBase", init<size_t, size_t>("Do not use the default constructor of base class"))
    ...
    class_<GridCalibrationTargetCheckerboard::CheckerboardOptions>("CheckerboardOptions", init<>())
        .def_readwrite("useAdaptiveThreshold",
                       &GridCalibrationTargetCheckerboard::CheckerboardOptions::useAdaptiveThreshold)
        ...
        .def_readwrite("doSubpixelRefinement",
                       &GridCalibrationTargetCheckerboard::CheckerboardOptions::doSubpixelRefinement)
        .def_readwrite("showExtractionVideo",
                       &GridCalibrationTargetCheckerboard::CheckerboardOptions::showExtractionVideo)
    ...
    class_<GridCalibrationTargetCheckerboard, bases<GridCalibrationTargetBase>,
        ...
        init<size_t, size_t, double, double, GridCalibrationTargetCheckerboard::CheckerboardOptions>(
            "GridCalibrationTargetCheckerboard(size_t rows, size_t cols, double rowSpacingMeters, double "
            "colSpacingMeters, CheckerboardOptions options)"))
        .def(init<size_t, size_t, double, double>("GridCalibrationTargetCheckerboard(size_t rows, size_t cols, double "
                                                  "rowSpacingMeters, double colSpacingMeters)"))
        .def(init<>("Do not use the default constructor. It is only necessary for the pickle interface"))
    ...
    class_<GridCalibrationTargetCirclegrid::CirclegridOptions>("CirclegridOptions", init<>())
        .def_readwrite("useAsymmetricCirclegrid",
                       &GridCalibrationTargetCirclegrid::CirclegridOptions::useAsymmetricCirclegrid)
    ...
    class_<GridCalibrationTargetCirclegrid, bases<GridCalibrationTargetBase>,
        ...
        init<size_t, size_t, double, GridCalibrationTargetCirclegrid::CirclegridOptions>(
            "GridCalibrationTargetCirclegrid(size_t rows, size_t cols, double spacingMeters, CirclegridOptions "
            "options)"))
    ...
    GridCalibrationTargetBase::Ptr (GridCalibrationTargetObservation::*target)() =
        &GridCalibrationTargetObservation::target;

    class_<GridCalibrationTargetObservation, boost::shared_ptr<GridCalibrationTargetObservation> >(
        ...
        // old fct: use getCornersTargetFrame / getCornersImageFrame instead (makes the distinction between april and
        // normal tags)
