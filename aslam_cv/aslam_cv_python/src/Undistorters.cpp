...
boost::shared_ptr<aslam::FrameBase> buildFrame(
    aslam::UndistorterBase* undistorter, const Eigen::Matrix<boost::uint8_t, Eigen::Dynamic, Eigen::Dynamic>& from) {
    cv::Mat to;
    eigen2cv(from, to);
...
void exportUndistorters() {
    ...
    class_<UndistorterBase, boost::shared_ptr<UndistorterBase>, boost::noncopyable>("UndistorterBase", no_init)
        .def("buildFrame", &buildFrame)
        .def("idealGeometry", &UndistorterBase::idealGeometryBase)
        .def("distortedGeometry", &UndistorterBase::distortedGeometryBase);

    def("createUndistorter", &UndistorterBase::createUndistorter,
