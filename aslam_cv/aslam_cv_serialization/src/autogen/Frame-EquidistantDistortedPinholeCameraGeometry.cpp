...
template void Frame<aslam::cameras::EquidistantDistortedPinholeCameraGeometry>::save<>(
    boost::archive::text_oarchive& ar, const unsigned int version) const;
template void Frame<aslam::cameras::EquidistantDistortedPinholeCameraGeometry>::load<>(
    boost::archive::text_iarchive& ar, const unsigned int version);
template void Frame<aslam::cameras::EquidistantDistortedPinholeCameraGeometry>::save<>(
    boost::archive::xml_oarchive& ar, const unsigned int version) const;
template void Frame<aslam::cameras::EquidistantDistortedPinholeCameraGeometry>::load<>(boost::archive::xml_iarchive& ar,
