...
template void Frame<aslam::cameras::MaskedEquidistantDistortedOmniRsCameraGeometry>::save<>(
    boost::archive::text_oarchive& ar, const unsigned int version) const;
template void Frame<aslam::cameras::MaskedEquidistantDistortedOmniRsCameraGeometry>::load<>(
