 ...
 * \param[in] cholmod cholmod workspace
 */
cholmod_dense* columnScalingMatrix(cholmod_sparse* A, cholmod_common* cholmod,
 ...
 * \param[in] eps tolerance for when to consider an element zero
 */
cholmod_sparse* eigenDenseToCholmodSparseCopy(const Eigen::MatrixXd& in, cholmod_common* cholmod,
                                              double eps = std::numeric_limits<double>::epsilon());
/**
 ...
 */
double rankTol(const Eigen::VectorXd& sv, double eps = std::numeric_limits<double>::epsilon());
/**
 ...
 * \param[in] eps machine precision
 */
double qrTol(cholmod_sparse* A, cholmod_common* cholmod, double eps = std::numeric_limits<double>::epsilon());
/**
