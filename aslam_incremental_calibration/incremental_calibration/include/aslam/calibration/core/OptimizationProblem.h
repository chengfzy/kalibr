...
class OptimizationProblem : public aslam::backend::OptimizationProblemBase {
  public:
    ...
    typedef std::unordered_map<const DesignVariable*, size_t> DesignVariablesP;
    /// Error term type
    ...
    typedef std::unordered_map<size_t, DesignVariablesSP> DesignVariableSPGroups;
    ...
    void addDesignVariable(const DesignVariableSP& designVariable, size_t groupId = 0);
