...
/** The IncompleteGammaPFunction class represents the complementary
  ...
  */
class IncompleteGammaPFunction : public ContinuousFunction<double, double>, public virtual Serializable {
  public:
    /** \name Types
      @{
      */
    ...
    /// Assignment operator
    IncompleteGammaPFunction& operator=(const IncompleteGammaPFunction& other);
    /// Destructor
