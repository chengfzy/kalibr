...
/** The Transformation3d class represents a 3d transformation.
  ...
  */
template <typename T>
class Transformation<T, 3> : public virtual Serializable {
  public:
    ...
    void setTransformationMatrix(const Eigen::Matrix<double, 4, 4>& transformationMatrix);
    ...
    /// Transform a point
    void transform(const Eigen::Matrix<T, 3, 1>& src, Eigen::Matrix<T, 3, 1>& dest) const;
