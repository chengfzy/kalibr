...
/** The NormalDistributionMv class represents a multivariate normal
  ...
  */
template <int M>
class NormalDistribution : public ContinuousDistribution<double, M>,
  ...
  public:
    ...
    NormalDistribution(const Mean& mean = Mean::Zero(), const Covariance& covariance = Covariance::Identity());
