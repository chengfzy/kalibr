...
/** The UniformDistribution1v class represents an interface to the
  ...
  */
template <typename X>
class UniformDistribution<X>
    : public IfThenElse<typename IsReal<X>::Result, ContinuousDistribution<X>, DiscreteDistribution<X> >::Result,
  ...
  public:
    /** \name Types
      ...
      */
    /// Distribution type
    typedef typename IfThenElse<typename IsReal<X>::Result, ContinuousDistribution<X>, DiscreteDistribution<X> >::Result
        DistributionType;
    ...
    UniformDistribution(const RandomVariable& minSupport = X(0), const RandomVariable& maxSupport = X(1));
    /// Copy constructor
