...
class UniformDistribution
    : public IfThenElse<typename IsReal<X>::Result, ContinuousDistribution<X, M>, DiscreteDistribution<X, M> >::Result,
  ...
  public:
    ...
    /** \name Types
      ...
      */
    /// Distribution type
    typedef typename IfThenElse<typename IsReal<X>::Result, ContinuousDistribution<X, M>,
                                DiscreteDistribution<X, M> >::Result DistributionType;
    ...
    struct Traits {
      public:
        ...
        static Z getSupportArea(const Eigen::Matrix<Z, M, 1>& minSupport, const Eigen::Matrix<Z, M, 1>& maxSupport);
        /// Get support area for integer types
        template <typename Z, typename IsInteger<Z>::Result::Numeric>
        static Z getSupportArea(const Eigen::Matrix<Z, M, 1>& minSupport, const Eigen::Matrix<Z, M, 1>& maxSupport);
        /// Get covariance for real types
        template <typename Z, typename IsReal<Z>::Result::Numeric>
        static Eigen::Matrix<double, M, M> getCovariance(const Eigen::Matrix<Z, M, 1>& minSupport,
    ...
    void setSupport(const RandomVariable& minSupport, const RandomVariable& maxSupport);
