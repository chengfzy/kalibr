...
NormalDistribution<1>::NormalDistribution(const std::tuple<Mean, Variance>& parameters)
...
NormalDistribution<1>& NormalDistribution<1>::operator=(const NormalDistribution& other) {
    if (this != &other) {
        mMean = other.mMean;
        mVariance = other.mVariance;
        mPrecision = other.mPrecision;
...
void NormalDistribution<1>::write(std::ostream& stream) const {
    stream << "mean: " << mMean << std::endl << "variance: " << mVariance;
}
...
void NormalDistribution<1>::setMean(Mean mean) { mMean = mean; }

NormalDistribution<1>::Mean NormalDistribution<1>::getMean() const { return mMean; }
...
NormalDistribution<1>::Variance NormalDistribution<1>::getVariance() const { return mVariance; }

NormalDistribution<1>::Precision NormalDistribution<1>::getPrecision() const { return mPrecision; }

NormalDistribution<1>::Std NormalDistribution<1>::getStandardDeviation() const { return mStandardDeviation; }

double NormalDistribution<1>::getNormalizer() const { return mNormalizer; }

double NormalDistribution<1>::pdf(const RandomVariable& value) const { return exp(logpdf(value)); }
...
double NormalDistribution<1>::KLDivergence(const NormalDistribution<1>& other) const {
    return 0.5 * (log(other.mVariance * mPrecision) + other.mPrecision * mVariance - 1.0 +
                  (mMean - other.mMean) * other.mPrecision * (mMean - other.mMean));
}

double NormalDistribution<1>::mahalanobisDistance(const RandomVariable& value) const {
    return (value - mMean) * mPrecision * (value - mMean);
}

NormalDistribution<1>::Median NormalDistribution<1>::getMedian() const { return mMean; }

NormalDistribution<1>::Mode NormalDistribution<1>::getMode() const { return mMean; }
