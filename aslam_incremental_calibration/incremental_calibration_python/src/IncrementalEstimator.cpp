...
Eigen::MatrixXd getNobsBasis(const IncrementalEstimator* ie) { return ie->getNobsBasis(); }

/// This functions gets rid of the reference
Eigen::MatrixXd getNobsBasisScaled(const IncrementalEstimator* ie) { return ie->getNobsBasis(true); }

/// This functions gets rid of the reference
Eigen::MatrixXd getObsBasis(const IncrementalEstimator* ie) { return ie->getObsBasis(); }

/// This functions gets rid of the reference
Eigen::MatrixXd getObsBasisScaled(const IncrementalEstimator* ie) { return ie->getObsBasis(true); }

/// This functions gets rid of the reference
Eigen::MatrixXd getSigma2Theta(const IncrementalEstimator* ie) { return ie->getSigma2Theta(); }

/// This functions gets rid of the reference
Eigen::MatrixXd getSigma2ThetaScaled(const IncrementalEstimator* ie) { return ie->getSigma2Theta(true); }

/// This functions gets rid of the reference
Eigen::MatrixXd getSigma2ThetaObs(const IncrementalEstimator* ie) { return ie->getSigma2ThetaObs(); }

/// This functions gets rid of the reference
Eigen::MatrixXd getSigma2ThetaObsScaled(const IncrementalEstimator* ie) { return ie->getSigma2ThetaObs(true); }

/// This functions gets rid of the reference
Eigen::MatrixXd getSingularValues(const IncrementalEstimator* ie) { return ie->getSingularValues(); }

/// This functions gets rid of the reference
Eigen::MatrixXd getScaledSingularValues(const IncrementalEstimator* ie) { return ie->getSingularValues(true); }
...
void exportIncrementalEstimator() {
    ...
    class_<IncrementalEstimator::Options>("IncrementalEstimatorOptions", init<>())
        .def_readwrite("infoGainDelta", &IncrementalEstimator::Options::infoGainDelta)
        .def_readwrite("checkValidity", &IncrementalEstimator::Options::checkValidity)
    ...
    class_<IncrementalEstimator::ReturnValue>("IncrementalEstimatorReturnValue", init<>())
        .def_readwrite("batchAccepted", &IncrementalEstimator::ReturnValue::batchAccepted)
        .def_readwrite("informationGain", &IncrementalEstimator::ReturnValue::informationGain)
        .def_readwrite("rankPsi", &IncrementalEstimator::ReturnValue::rankPsi)
        .def_readwrite("rankPsiDeficiency", &IncrementalEstimator::ReturnValue::rankPsiDeficiency)
        .def_readwrite("rankTheta", &IncrementalEstimator::ReturnValue::rankTheta)
        .def_readwrite("rankThetaDeficiency", &IncrementalEstimator::ReturnValue::rankThetaDeficiency)
        .def_readwrite("svdTolerance", &IncrementalEstimator::ReturnValue::svdTolerance)
        .def_readwrite("qrTolerance", &IncrementalEstimator::ReturnValue::qrTolerance)
        .def_readwrite("nobsBasis", &IncrementalEstimator::ReturnValue::nobsBasis)
        .def_readwrite("nobsBasisScaled", &IncrementalEstimator::ReturnValue::nobsBasisScaled)
        .def_readwrite("obsBasis", &IncrementalEstimator::ReturnValue::obsBasis)
        .def_readwrite("obsBasisScaled", &IncrementalEstimator::ReturnValue::obsBasisScaled)
        .def_readwrite("sigma2Theta", &IncrementalEstimator::ReturnValue::sigma2Theta)
        .def_readwrite("sigma2ThetaScaled", &IncrementalEstimator::ReturnValue::sigma2ThetaScaled)
        .def_readwrite("sigma2ThetaObs", &IncrementalEstimator::ReturnValue::sigma2ThetaObs)
        .def_readwrite("sigma2ThetaObsScaled", &IncrementalEstimator::ReturnValue::sigma2ThetaObsScaled)
        .def_readwrite("singularValues", &IncrementalEstimator::ReturnValue::singularValues)
        .def_readwrite("singularValuesScaled", &IncrementalEstimator::ReturnValue::singularValuesScaled)
        .def_readwrite("numIterations", &IncrementalEstimator::ReturnValue::numIterations)
        .def_readwrite("JStart", &IncrementalEstimator::ReturnValue::JStart)
        .def_readwrite("JFinal", &IncrementalEstimator::ReturnValue::JFinal)
        .def_readwrite("elapsedTime", &IncrementalEstimator::ReturnValue::elapsedTime);
    ...
    void (IncrementalEstimator::*removeBatch2)(const IncrementalEstimator::BatchSP&) =
        &IncrementalEstimator::removeBatch;

    /// Export IncrementalEstimator class
    class_<IncrementalEstimator, boost::shared_ptr<IncrementalEstimator>, boost::noncopyable>(
        "IncrementalEstimator",
        init<size_t, const IncrementalEstimator::Options&, const LinearSolverOptions&, const Optimizer2Options&>(
        ...
        .def("getRankThetaDeficiency", &IncrementalEstimator::getRankThetaDeficiency)
