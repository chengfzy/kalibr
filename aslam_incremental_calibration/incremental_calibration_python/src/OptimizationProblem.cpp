...
void exportOptimizationProblem() {
    ...
    class_<aslam::calibration::OptimizationProblem, boost::shared_ptr<aslam::calibration::OptimizationProblem>,
           boost::noncopyable, boost::python::bases<aslam::backend::OptimizationProblemBase> >(
    ...
    aslam::calibration::OptimizationProblem* (IncrementalOptimizationProblem::*getOp)(size_t) =
    ...
    class_<aslam::calibration::IncrementalOptimizationProblem,
           boost::shared_ptr<aslam::calibration::IncrementalOptimizationProblem>, boost::noncopyable,
           boost::python::bases<aslam::backend::OptimizationProblemBase> >("IncrementalOptimizationProblem", init<>())
