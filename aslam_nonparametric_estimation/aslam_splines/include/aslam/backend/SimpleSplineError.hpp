...
class SimpleSplineError : public ErrorTermFs<1> {
  public:
    ...
    SimpleSplineError(spline_t* splineDV, expression_t* splineExpression,
                      Eigen::Matrix<double, spline_t::Dimension, 1> y, double t);
  ...
  protected:
    ...
    //  virtual void buildHessianImplementation(SparseBlockMatrix & outHessian, Eigen::VectorXd & outRhs,bool
    //  useMEstimator);
