...
struct ExpressionNodeFunctor {
    ...
    ExpressionNodeFunctor(expression_t dv) : _dv(dv) {}
    ...
    void testJacobian() {
        ...
        sm::eigen::assertNear(Jc.asSparseMatrix(), Jest, 1e-6, SM_SOURCE_FILE_POS,
                              "Testing the expression jacobian. A is analytical and B is from finite differences");
    }
};
