...
class BSplinePose : public BSpline {
  public:
    ...
    Eigen::Matrix4d transformationAndJacobian(double tk, Eigen::MatrixXd *J = NULL,
                                              Eigen::VectorXi *coefficientIndices = NULL) const;

    Eigen::Matrix4d inverseTransformationAndJacobian(double tk, Eigen::MatrixXd *J = NULL,
                                                     Eigen::VectorXi *coefficientIndices = NULL) const;
    Eigen::Matrix4d inverseTransformation(double tk) const;

    Eigen::Vector4d transformVectorAndJacobian(double tk, const Eigen::Vector4d &v, Eigen::MatrixXd *J = NULL,
                                               Eigen::VectorXi *coefficientIndices = NULL) const;
