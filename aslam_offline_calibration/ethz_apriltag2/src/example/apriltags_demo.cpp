...
class Demo {
  ...
  public:
    ...
    void setup() {
        ...
        cout << "Actual resolution: " << m_cap.get(CV_CAP_PROP_FRAME_WIDTH) << "x"
    ...
    void print_detection(AprilTags::TagDetection& detection) const {
        ...
        cout << "  distance=" << translation.norm() << "m, x=" << translation(0) << ", y=" << translation(1)
             << ", z=" << translation(2) << ", yaw=" << yaw << ", pitch=" << pitch << ", roll=" << roll << endl;
        ...
        while (true) {
            ...
            if (m_arduino) {
                if (detections.size() > 0) {
                    ...
                    Eigen::Vector3d translation;
                    Eigen::Matrix3d rotation;
                    detections[0].getRelativeTranslationRotation(m_tagSize, m_fx, m_fy, m_px, m_py, translation,
                                                                 rotation);
