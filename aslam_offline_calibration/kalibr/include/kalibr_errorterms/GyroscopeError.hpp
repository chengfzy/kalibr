...
class GyroscopeError : public EuclideanError {
  public:
    ...
    GyroscopeError(const Eigen::Vector3d& measurement, const Eigen::Matrix3d& invR,
...
class GyroscopeErrorEccentric : public EuclideanError {
  public:
    ...
    GyroscopeErrorEccentric(const Eigen::Vector3d& measurement, const Eigen::Matrix3d& invR,
                            const aslam::backend::MatrixExpression& M, const aslam::backend::MatrixExpression& Ma,
...
class GyroscopeNoBiasError : public aslam::backend::ErrorTermFs<3> {
  public:
    ...
    GyroscopeNoBiasError(const Eigen::Vector3d& measurement, const Eigen::Matrix3d& invR,
                         const aslam::backend::EuclideanExpression& angularVelocity);
