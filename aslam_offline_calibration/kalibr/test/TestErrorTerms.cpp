...
// GyroscopeError(const Eigen::Vector3d & measurement, const Eigen::Matrix3d & invR, const
// aslam::backend::EuclideanExpression & angularVelocity, const aslam::backend::EuclideanExpression & bias );
...
TEST(ImuCameraTests, testAccelerometer) {
    ...
    AccelerometerError aerr(Eigen::Vector3d::Random(), Eigen::Matrix3d::Identity(), q_b_w.toExpression(),
                            a_w.toExpression(), bias.toExpression(), gravity.toExpression());
...
TEST(ImuCameraTests, testGyroscope) {
    ...
    GyroscopeError gerr(Eigen::Vector3d::Random(), Eigen::Matrix3d::Identity(), a_w.toExpression(),
                        bias.toExpression());
...
TEST(ImuCameraTests, testEccentricGyroscope) {
    ...
    GyroscopeErrorEccentric gerr(Eigen::Vector3d::Random(), Eigen::Matrix3d::Identity(), M.toExpression(),
                                 Ma.toExpression(), q_b_w.toExpression(), acceleration_w.toExpression(),
                                 angularVelocity_b.toExpression(), angularAcceleration_b.toExpression(),
                                 q_i_b.toExpression(), r_b.toExpression(), bias.toExpression(), g_w.toExpression());
...
TEST(ImuCameraTests, testEccentricAccelerometer) {
    ...
    AccelerometerErrorEccentric aerr(Eigen::Vector3d::Random(), Eigen::Matrix3d::Identity(), M.toExpression(),
                                     q_b_w.toExpression(), acceleration_w.toExpression(),
                                     angularVelocity_b.toExpression(), angularAcceleration_b.toExpression(),
                                     q_i_b.toExpression(), rx_b.toExpression(), ry_b.toExpression(),
                                     rz_b.toExpression(), bias.toExpression(), g_w.toExpression());
