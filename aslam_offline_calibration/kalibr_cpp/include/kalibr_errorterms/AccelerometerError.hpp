...
class AccelerometerError : public EuclideanError {
  public:
    ...
    AccelerometerError(const Eigen::Vector3d& measurement, const Eigen::Matrix3d& invR,
                       ...
                       const aslam::backend::EuclideanExpression& bias, const aslam::backend::EuclideanExpression& g_w);
...
class AccelerometerErrorEccentric : public EuclideanError {
  public:
    ...
    AccelerometerErrorEccentric(
        ...
        const aslam::backend::RotationExpression& C_i_b, const aslam::backend::EuclideanExpression& rx_b,
        const aslam::backend::EuclideanExpression& ry_b, const aslam::backend::EuclideanExpression& rz_b,
        const aslam::backend::EuclideanExpression& bias, const aslam::backend::EuclideanExpression& g_w);
