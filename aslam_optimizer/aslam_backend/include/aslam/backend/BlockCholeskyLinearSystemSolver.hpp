...
class BlockCholeskyLinearSystemSolver : public LinearSystemSolver {
  public:
    ...
    BlockCholeskyLinearSystemSolver(
        ...
        const BlockCholeskyLinearSolverOptions& options = BlockCholeskyLinearSolverOptions());
    ...
    virtual const Matrix* Hessian() const { return &_H; }
  ...
  private:
    ...
    virtual void initMatrixStructureImplementation(const std::vector<DesignVariable*>& dvs,
