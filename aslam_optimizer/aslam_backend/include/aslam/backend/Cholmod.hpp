...
class Cholmod {
  public:
...
#ifndef QRSOLVER_DISABLED
    bool factorize(cholmod_sparse* A, spqr_factor* L, double tol = SPQR_DEFAULT_TOL, bool transpose = false);
#endif
    ...
    cholmod_dense* solve(cholmod_sparse* A, cholmod_factor* L, cholmod_dense* b);

#ifndef QRSOLVER_DISABLED
    cholmod_dense* solve(cholmod_sparse* A, spqr_factor* L, cholmod_dense* b, double tol = SPQR_DEFAULT_TOL,
                         bool norm = true, double normTol = 1e-8);
#endif
