...
class DesignVariable {
  public:
    ...
    /// \brief Computes the minimal distance in tangent space between the current value of the DV and xHat and the
    /// jacobian
    void minimalDifferenceAndJacobian(const Eigen::MatrixXd& xHat, Eigen::VectorXd& outDifference,
  ...
  protected:
    ...
    /// Returns the content of the design variable
    virtual void getParametersImplementation(Eigen::MatrixXd& value) const = 0;
