...
class LinearSystemSolver {
  public:
    ...
    virtual const Matrix* Jacobian() const { return NULL; }

    /// \brief return the Hessian matrix if avaliable. Null if not available.
    virtual const Matrix* Hessian() const { return NULL; }
