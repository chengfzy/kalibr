...
/** The class BlakeZissermanMEstimator implements the Blake-Zisserman
  ...
  */
class BlakeZissermanMEstimator : public MEstimator {
  public:
     ...
     * @return
     */
    BlakeZissermanMEstimator(size_t df, double pCut = 0.999, double wCut = 0.1);
    /// Copy constructor
    BlakeZissermanMEstimator(const BlakeZissermanMEstimator& other);
    /// Assignment operator
    BlakeZissermanMEstimator& operator=(const BlakeZissermanMEstimator& other);
    /// Destructor
