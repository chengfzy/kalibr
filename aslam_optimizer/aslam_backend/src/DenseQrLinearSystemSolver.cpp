...
DenseQrLinearSystemSolver::DenseQrLinearSystemSolver(const DenseQRLinearSolverOptions& options) : _options(options) {}
...
const Matrix* DenseQrLinearSystemSolver::Jacobian() const { return &_J; }

void DenseQrLinearSystemSolver::initMatrixStructureImplementation(const std::vector<DesignVariable*>& /* dvs */,
...
void DenseQrLinearSystemSolver::buildSystem(size_t nThreads, bool useMEstimator) {
    _J._M.setZero();
    setupThreadedJob(boost::bind(&DenseQrLinearSystemSolver::evaluateJacobians, this, _1, _2, _3, _4), nThreads,
                     useMEstimator);
...
void DenseQrLinearSystemSolver::evaluateJacobians(size_t /* threadId */, size_t startIdx, size_t endIdx,
                                                  bool useMEstimator) {
...
const DenseQRLinearSolverOptions& DenseQrLinearSystemSolver::getOptions() const { return _options; }

DenseQRLinearSolverOptions& DenseQrLinearSystemSolver::getOptions() { return _options; }

void DenseQrLinearSystemSolver::setOptions(const DenseQRLinearSolverOptions& options) { _options = options; }
...
const Eigen::MatrixXd& DenseQrLinearSystemSolver::getJacobian() const { return _J._M; }
