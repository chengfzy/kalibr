...
LevenbergMarquardtTrustRegionPolicy::LevenbergMarquardtTrustRegionPolicy()
    : _lambdaInit(1e-3), _gammaInit(3), _betaInit(2), _pInit(3), _muInit(2) {}
LevenbergMarquardtTrustRegionPolicy::LevenbergMarquardtTrustRegionPolicy(double lambdaInit)
    : _lambdaInit(lambdaInit), _gammaInit(3), _betaInit(2), _pInit(3), _muInit(2) {}
...
bool LevenbergMarquardtTrustRegionPolicy::solveSystemImplementation(double /* J */, bool previousIterationFailed,
                                                                    int nThreads, Eigen::VectorXd& outDx) {
...
bool LevenbergMarquardtTrustRegionPolicy::revertOnFailure() { return true; }
...
bool LevenbergMarquardtTrustRegionPolicy::requiresAugmentedDiagonal() const { return true; }
}  // namespace backend
}  // namespace aslam
