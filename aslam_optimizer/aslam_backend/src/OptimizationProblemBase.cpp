...
size_t OptimizationProblemBase::numDesignVariables() const { return numDesignVariablesImplementation(); }
...
size_t OptimizationProblemBase::numErrorTerms() const { return numErrorTermsImplementation(); }
