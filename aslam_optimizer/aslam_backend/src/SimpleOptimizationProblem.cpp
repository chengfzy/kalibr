...
void SimpleOptimizationProblem::addErrorTerm(const boost::shared_ptr<ErrorTerm>& et) { _errorTerms.push_back(et); }
...
size_t SimpleOptimizationProblem::numDesignVariablesImplementation() const { return _designVariables.size(); }

DesignVariable* SimpleOptimizationProblem::designVariableImplementation(size_t i) { return _designVariables[i].get(); }

const DesignVariable* SimpleOptimizationProblem::designVariableImplementation(size_t i) const {
    return _designVariables[i].get();
}

size_t SimpleOptimizationProblem::numErrorTermsImplementation() const { return _errorTerms.size(); }

ErrorTerm* SimpleOptimizationProblem::errorTermImplementation(size_t i) { return _errorTerms[i].get(); }

const ErrorTerm* SimpleOptimizationProblem::errorTermImplementation(size_t i) const { return _errorTerms[i].get(); }

void SimpleOptimizationProblem::getErrorsImplementation(const DesignVariable* /*dv*/,
