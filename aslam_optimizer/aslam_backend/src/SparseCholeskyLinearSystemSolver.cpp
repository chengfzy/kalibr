...
namespace aslam {
namespace backend {
SparseCholeskyLinearSystemSolver::SparseCholeskyLinearSystemSolver(const SparseCholeskyLinearSolverOptions& options)
...
void SparseCholeskyLinearSystemSolver::initMatrixStructureImplementation(const std::vector<DesignVariable*>& dvs,
...
const SparseCholeskyLinearSolverOptions& SparseCholeskyLinearSystemSolver::getOptions() const { return _options; }

SparseCholeskyLinearSolverOptions& SparseCholeskyLinearSystemSolver::getOptions() { return _options; }

void SparseCholeskyLinearSystemSolver::setOptions(const SparseCholeskyLinearSolverOptions& options) {
    _options = options;
}
