...
boost::shared_ptr<LinearSystemSolver> TrustRegionPolicy::getSolver() { return _solver; }

/// \brief set the linear system solver
void TrustRegionPolicy::setSolver(boost::shared_ptr<LinearSystemSolver> solver) { _solver = solver; }

bool TrustRegionPolicy::revertOnFailure() { return true; }
...
double TrustRegionPolicy::get_dJ() { return _p_J - _J; }
