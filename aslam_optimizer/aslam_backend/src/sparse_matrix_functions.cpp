...
void applySchurComplement(sparse_block_matrix::SparseBlockMatrix<Eigen::MatrixXd>& H, const Eigen::VectorXd& rhs,
                          double lambda, int marginalizedStartingBlock, bool doLevenbergMarquardt,
                          sparse_block_matrix::SparseBlockMatrix<Eigen::MatrixXd>& A,
                          std::vector<Eigen::MatrixXd>& invVi, Eigen::VectorXd& b) {
...
void buildDsi(int i, sparse_block_matrix::SparseBlockMatrix<Eigen::MatrixXd>& H, const Eigen::VectorXd& rhs,
              int marginalizedStartingBlock, const Eigen::MatrixXd& invVi, const Eigen::VectorXd& dx,
