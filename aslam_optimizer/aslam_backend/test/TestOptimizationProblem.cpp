...
class Et1 : public ErrorTermFs<3> {
  public:
    Et1(DesignVariable* dv) { setDesignVariables(dv); }

  protected:
    /// \brief evaluate the error term
    virtual double evaluateErrorImplementation() { return 0.0; }
...
class Et2 : public ErrorTermFs<3> {
  public:
    Et2(DesignVariable* dv1, DesignVariable* dv2) { setDesignVariables(dv1, dv2); }
