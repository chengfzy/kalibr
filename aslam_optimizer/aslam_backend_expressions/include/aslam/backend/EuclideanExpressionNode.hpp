...
class EuclideanExpressionNodeMatrixMultiply : public EuclideanExpressionNode {
  public:
    ...
    EuclideanExpressionNodeMatrixMultiply(boost::shared_ptr<MatrixExpressionNode> lhs,
                                          boost::shared_ptr<EuclideanExpressionNode> rhs);
...
class EuclideanExpressionNodeSubtractVector : public EuclideanExpressionNode {
  public:
    ...
    EuclideanExpressionNodeSubtractVector(boost::shared_ptr<EuclideanExpressionNode> lhs, const Eigen::Vector3d& rhs);
...
class EuclideanExpressionNodeScalarMultiply : public EuclideanExpressionNode {
  public:
    ...
    EuclideanExpressionNodeScalarMultiply(boost::shared_ptr<EuclideanExpressionNode> p,
                                          boost::shared_ptr<ScalarExpressionNode> s);
...
class EuclideanExpressionNodeRotationParameters : public EuclideanExpressionNode {
  public:
    ...
    EuclideanExpressionNodeRotationParameters(boost::shared_ptr<RotationExpressionNode> operand,
                                              sm::kinematics::RotationalKinematics::Ptr rk);
