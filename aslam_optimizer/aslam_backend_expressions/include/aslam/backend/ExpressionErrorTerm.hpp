...
class ExpressionErrorTerm : public aslam::backend::ErrorTermFs<IDimension> {
  public:
    ...
    inline TExpression getExpression() { return _expression; }
...
inline ::boost::shared_ptr<ExpressionErrorTerm<TExpression, IDimension>> toErrorTerm(TExpression expression) {
    return ::boost::shared_ptr<ExpressionErrorTerm<TExpression, IDimension>>(
        new ExpressionErrorTerm<TExpression, IDimension>(expression));
}
