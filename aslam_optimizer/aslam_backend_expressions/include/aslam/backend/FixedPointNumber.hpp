...
class FixedPointNumber {
  public:
    ...
    inline explicit FixedPointNumber(FixedPointNumber<OtherInteger_, OtherDivider_> const& other) {
        _p = other._p * getDivider() / other.getDivider();
    }
    ...
    ~FixedPointNumber() {
        ...
        static_assert((std::uintmax_t)((Integer)Divider) == Divider,
                      "the Divider must be loss less convertible to the Integer_ type");
    }
    ...
    FixedPointNumber operator-() const { return FixedPointNumber((Integer)(-_p)); }
    ...
    FixedPointNumber operator*(const FixedPointNumber& other) const {
        return FixedPointNumber(
            (Integer)(((NextBiggerType)_p * (NextBiggerType)other._p) / (NextBiggerType)other.getDivider()));
    }
    FixedPointNumber& operator*=(const FixedPointNumber& other) {
        *this = *this * other;
        return *this;
    ...
    FixedPointNumber operator/(const FixedPointNumber& other) const {
        return FixedPointNumber(
            (Integer)(((NextBiggerType)_p * (NextBiggerType)other.getDivider()) / (NextBiggerType)other._p));
    }
    FixedPointNumber& operator/=(const FixedPointNumber& other) {
        *this = *this / other;
        return *this;
    ...
    inline bool operator==(const FixedPointNumber& other) const { return _p == other._p; }
    inline bool operator!=(const FixedPointNumber& other) const { return _p != other._p; }
