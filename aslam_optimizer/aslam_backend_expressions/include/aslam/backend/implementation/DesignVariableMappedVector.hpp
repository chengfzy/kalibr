...
void DesignVariableMappedVector<D>::evaluateJacobiansImplementation(JacobianContainer& outJacobians) const {
    SM_ASSERT_EQ_DBG(Exception, outJacobians.rows(), D,
...
template <int D>
void DesignVariableMappedVector<D>::evaluateJacobiansImplementation(JacobianContainer& outJacobians,
...
template <int D>
void DesignVariableMappedVector<D>::getParametersImplementation(Eigen::MatrixXd& value) const {
    value = _v;
}

template <int D>
void DesignVariableMappedVector<D>::setParametersImplementation(const Eigen::MatrixXd& value) {
    _p_v = _v;
    _v = value;
}

template <int D>
void DesignVariableMappedVector<D>::minimalDifferenceImplementation(const Eigen::MatrixXd& xHat,
...
template <int D>
void DesignVariableMappedVector<D>::minimalDifferenceAndJacobianImplementation(const Eigen::MatrixXd& xHat,
