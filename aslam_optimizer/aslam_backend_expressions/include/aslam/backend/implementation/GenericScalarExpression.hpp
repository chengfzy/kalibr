...
template <typename Scalar_>
void GenericScalarExpression<Scalar_>::evaluateJacobians(JacobianContainer& outJacobians,
...
class GenericScalarExpressionNodeCasted : public GSEUnRes<Scalar_, GenericScalarExpressionNode<OtherScalar_> > {
  ...
  protected:
    Scalar_ toScalarImplementation() const { return Scalar_(this->_lhs->toScalar()); }
...
class GenericScalarExpressionNodeMultiply : public GSEBinRes<Scalar_> {
  ...
  protected:
    Scalar_ toScalarImplementation() const { return this->_lhs->toScalar() * this->_rhs->toScalar(); }
...
class GenericScalarExpressionNodeNegated : public GSEUnRes<Scalar_, GenericScalarExpressionNode<Scalar_> > {
  ...
  protected:
    Scalar_ toScalarImplementation() const { return -this->_lhs->toScalar(); }
...
class GenericScalarExpressionNodeFromVectorExpression : public GSEUnRes<Scalar_, VectorExpressionNode<1> > {
  ...
  protected:
    ...
    double toScalarImplementation() const { return this->_lhs->evaluate()(0); }
...
template <typename Scalar_>
GenericScalarExpression<Scalar_>::GenericScalarExpression(Scalar_ value)
    : _root(new internal::GenericScalarExpressionNodeConstant<Scalar_>(value)) {}

template <typename Scalar_>
template <typename OtherScalar, typename>
inline GenericScalarExpression<Scalar_>::GenericScalarExpression(const GenericScalarExpression<OtherScalar>& other)
    : _root(new internal::GenericScalarExpressionNodeCasted<Scalar_, OtherScalar>(other._root)) {}
