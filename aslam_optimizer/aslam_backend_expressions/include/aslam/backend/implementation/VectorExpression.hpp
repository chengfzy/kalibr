...
template <int D>
VectorExpression<D>::VectorExpression(boost::shared_ptr<VectorExpressionNode<D> > root) : _root(root) {}

template <int D>
VectorExpression<D>::VectorExpression(VectorExpressionNode<D>* root) : _root(root, sm::null_deleter()) {}
...
template <int D>
void VectorExpression<D>::evaluateJacobians(JacobianContainer& outJacobians,
