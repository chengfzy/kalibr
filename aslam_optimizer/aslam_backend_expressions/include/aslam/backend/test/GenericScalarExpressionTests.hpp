...
struct ExpressionTraits<GenericScalarExpression<FixedPointNumber<Scalar_, Divider>>> {
    ...
    static double defaultTolerance() { return (double)Limits::epsilon() * 1E2; }
    static double defaulEps() { return (double)Limits::epsilon() * 10; }
};
...
struct ExpressionEvaluationTraits<GenericScalarExpression<FixedPointNumber<Scalar_, Divider>>> {
    typedef
        typename ExpressionValueTraits<GenericScalarExpression<FixedPointNumber<Scalar_, Divider>>>::value_t value_t;
