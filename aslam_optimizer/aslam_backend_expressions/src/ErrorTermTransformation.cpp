...
ErrorTermTransformation::ErrorTermTransformation(aslam::backend::TransformationExpression T,
                                                 sm::kinematics::Transformation prior, Eigen::Matrix<double, 6, 6> N,
                                                 int debug)
...
ErrorTermTransformation::ErrorTermTransformation(aslam::backend::TransformationExpression T,
                                                 sm::kinematics::Transformation prior, double weightRotation,
...
void ErrorTermTransformation::evaluateJacobiansImplementation(JacobianContainer& _jacobians) const {
    ...
    J.block(3, 3, 3, 3) =
        rotVector.parametersToInverseSMatrix(sm::kinematics::R2AxisAngle(_errorMatrix.block(0, 0, 3, 3)));
