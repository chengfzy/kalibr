...
EuclideanExpression::EuclideanExpression(boost::shared_ptr<EuclideanExpressionNode> root) : _root(root) {}
...
EuclideanExpression::EuclideanExpression(const Eigen::Vector3d& p) : _root(new EuclideanExpressionNodeConstant(p)) {}

EuclideanExpression::~EuclideanExpression() {}

Eigen::Vector3d EuclideanExpression::toEuclidean() const { return _root->toEuclidean(); }
...
void EuclideanExpression::evaluateJacobians(JacobianContainer& outJacobians,
