...
Eigen::Vector4d HomogeneousExpression::toHomogeneous() const { return _root->toHomogeneous(); }
...
void HomogeneousExpression::evaluateJacobians(JacobianContainer& outJacobians,
