...
namespace aslam {
namespace backend {
HomogeneousPoint::HomogeneousPoint(const Eigen::Vector4d& p) : _p(p), _p_p(p) {
...
void HomogeneousPoint::revertUpdateImplementation() { _p = _p_p; }
...
int HomogeneousPoint::minimalDimensionsImplementation() const { return 3; }

Eigen::Vector4d HomogeneousPoint::toHomogeneousImplementation() const { return _p; }
...
void HomogeneousPoint::evaluateJacobiansImplementation(JacobianContainer& outJacobians,
...
HomogeneousExpression HomogeneousPoint::toExpression() { return HomogeneousExpression(this); }

void HomogeneousPoint::getParametersImplementation(Eigen::MatrixXd& value) const { value = _p; }

void HomogeneousPoint::setParametersImplementation(const Eigen::MatrixXd& value) {
    _p_p = _p;
    _p = value;
}

void HomogeneousPoint::minimalDifferenceImplementation(const Eigen::MatrixXd& xHat,
...
void HomogeneousPoint::minimalDifferenceAndJacobianImplementation(const Eigen::MatrixXd& xHat,
