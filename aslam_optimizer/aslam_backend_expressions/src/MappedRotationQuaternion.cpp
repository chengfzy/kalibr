...
int MappedRotationQuaternion::minimalDimensionsImplementation() const { return 3; }

Eigen::Matrix3d MappedRotationQuaternion::toRotationMatrixImplementation() const { return _C; }
...
void MappedRotationQuaternion::evaluateJacobiansImplementation(JacobianContainer& outJacobians,
                                                               const Eigen::MatrixXd& applyChainRule) const {
    outJacobians.add(const_cast<MappedRotationQuaternion*>(this), applyChainRule);
}

RotationExpression MappedRotationQuaternion::toExpression() { return RotationExpression(this); }
...
void MappedRotationQuaternion::getParametersImplementation(Eigen::MatrixXd& value) const { value = _q; }

void MappedRotationQuaternion::setParametersImplementation(const Eigen::MatrixXd& value) {
    _p_q = _q;
    _q = value;
    _C = sm::kinematics::quat2r(_q);
}

void MappedRotationQuaternion::minimalDifferenceImplementation(const Eigen::MatrixXd& xHat,
...
void MappedRotationQuaternion::minimalDifferenceAndJacobianImplementation(const Eigen::MatrixXd& xHat,
