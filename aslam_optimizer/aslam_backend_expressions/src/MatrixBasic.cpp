...
MatrixBasic::MatrixBasic(const Eigen::Matrix3d& A) : _A(A), _p_A(A), _B(Eigen::MatrixXd::Identity(9, 9)) {}

MatrixBasic::MatrixBasic(const Eigen::Matrix3d& A, const Eigen::Matrix3i& UpdatePattern) : _A(A), _p_A(A) {
...
void MatrixBasic::revertUpdateImplementation() { _A = _p_A; }
...
// ##
Eigen::Matrix3d MatrixBasic::toMatrix3x3Implementation() { return _A; }
...
MatrixExpression MatrixBasic::toExpression() { return MatrixExpression(this); }
...
void MatrixBasic::getParametersImplementation(Eigen::MatrixXd& value) const { value = _A; }

void MatrixBasic::setParametersImplementation(const Eigen::MatrixXd& value) {
    _p_A = _A;
    _A = value;
}
