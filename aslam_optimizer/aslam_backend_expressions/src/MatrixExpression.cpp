...
MatrixExpression::MatrixExpression(boost::shared_ptr<MatrixExpressionNode> node) : _root(node) {
    SM_ASSERT_TRUE(Exception, _root.get() != NULL,
...
Eigen::Matrix3d MatrixExpression::toMatrix3x3() { return _root->toMatrix3x3(); }
