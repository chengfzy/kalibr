...
void RotationExpressionNode::evaluateJacobians(JacobianContainer& outJacobians,
...
RotationExpressionNodeMultiply::RotationExpressionNodeMultiply(boost::shared_ptr<RotationExpressionNode> lhs,
...
void RotationExpressionNodeMultiply::evaluateJacobiansImplementation(JacobianContainer& outJacobians,
                                                                     const Eigen::MatrixXd& applyChainRule) const {
...
RotationExpressionNodeInverse::RotationExpressionNodeInverse(boost::shared_ptr<RotationExpressionNode> dvRotation)
    : _dvRotation(dvRotation) {
...
void RotationExpressionNodeInverse::evaluateJacobiansImplementation(JacobianContainer& outJacobians,
                                                                    const Eigen::MatrixXd& applyChainRule) const {
...
RotationExpressionNodeTransformation::RotationExpressionNodeTransformation(
    boost::shared_ptr<TransformationExpressionNode> transformation)
...
void RotationExpressionNodeTransformation::evaluateJacobiansImplementation(
...
void RotationExpressionNodeTransformation::getDesignVariablesImplementation(
