...
namespace aslam {
namespace backend {
Scalar::Scalar(const double& p) : _p(p), _p_p(p) {}
Scalar::~Scalar() {}

/// \brief Revert the last state update.
void Scalar::revertUpdateImplementation() { _p = _p_p; }
...
int Scalar::minimalDimensionsImplementation() const { return 1; }

double Scalar::toScalarImplementation() const { return _p; }
...
void Scalar::evaluateJacobiansImplementation(JacobianContainer& outJacobians,
...
ScalarExpression Scalar::toExpression() { return ScalarExpression(this); }
...
void Scalar::minimalDifferenceAndJacobianImplementation(const Eigen::MatrixXd& xHat, Eigen::VectorXd& outDifference,
