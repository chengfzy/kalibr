...
ScalarExpression::ScalarExpression(double value) : _root(new ScalarExpressionNodeConstant(value)) {}

ScalarExpression::ScalarExpression(ScalarExpressionNode* designVariable) : _root(designVariable, sm::null_deleter()) {}

ScalarExpression::ScalarExpression(boost::shared_ptr<ScalarExpressionNode> root) : _root(root) {}

ScalarExpression::~ScalarExpression() {}

double ScalarExpression::toScalar() const { return _root->toScalar(); }
