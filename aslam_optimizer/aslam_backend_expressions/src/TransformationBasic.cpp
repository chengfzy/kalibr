...
void TransformationBasic::evaluateJacobiansImplementation(JacobianContainer& outJacobians,
...
TransformationExpression TransformationBasic::toExpression() { return TransformationExpression(this); }
