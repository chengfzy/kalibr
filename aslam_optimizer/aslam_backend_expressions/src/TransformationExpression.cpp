...
TransformationExpression::TransformationExpression(const RotationExpression& rotation,
...
Eigen::Matrix4d TransformationExpression::toTransformationMatrix() const { return _root->toTransformationMatrix(); }
...
void TransformationExpression::evaluateJacobians(JacobianContainer& outJacobians,
