...
void TransformationExpressionNode::evaluateJacobians(JacobianContainer& outJacobians,
...
TransformationExpressionNodeMultiply::TransformationExpressionNodeMultiply(
    boost::shared_ptr<TransformationExpressionNode> lhs, boost::shared_ptr<TransformationExpressionNode> rhs)
    : _lhs(lhs), _rhs(rhs) {
...
void TransformationExpressionNodeMultiply::getDesignVariablesImplementation(
...
void TransformationExpressionNodeMultiply::evaluateJacobiansImplementation(
...
TransformationExpressionNodeInverse::TransformationExpressionNodeInverse(
    boost::shared_ptr<TransformationExpressionNode> dvTransformation)
    : _dvTransformation(dvTransformation) {
...
void TransformationExpressionNodeInverse::evaluateJacobiansImplementation(JacobianContainer& outJacobians,
                                                                          const Eigen::MatrixXd& applyChainRule) const {
    _dvTransformation->evaluateJacobians(outJacobians, (applyChainRule * -sm::kinematics::boxTimes(_T)));
}

void TransformationExpressionNodeInverse::getDesignVariablesImplementation(
    DesignVariable::set_t& designVariables) const {
...
void TransformationExpressionNodeConstant::evaluateJacobiansImplementation(
    JacobianContainer& /* outJacobians */) const {}
void TransformationExpressionNodeConstant::evaluateJacobiansImplementation(
    JacobianContainer& /* outJacobians */, const Eigen::MatrixXd& /* applyChainRule */) const {}
void TransformationExpressionNodeConstant::getDesignVariablesImplementation(
    DesignVariable::set_t& /* designVariables */) const {}
