...
Vector2RotationQuaternionExpressionAdapter::Vector2RotationQuaternionExpressionAdapter(
    const VectorExpression<4>& vectorExpression)
...
void Vector2RotationQuaternionExpressionAdapter::evaluateJacobiansImplementation(
...
void Vector2RotationQuaternionExpressionAdapter::getDesignVariablesImplementation(
