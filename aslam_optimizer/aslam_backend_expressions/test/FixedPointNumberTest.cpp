...
struct FixedPointNumberTestSuites : public ::testing::Test {
    ...
    TestFixedPointNumber getRand() { return TestFixedPointNumber((sm::random::rand() - 0.5) * 10); }
};

typedef ::testing::Types<FixedPointNumber<char, 10>, FixedPointNumber<short, 1000>, FixedPointNumber<int, 1000>,
                         FixedPointNumber<long, 1000000>, FixedPointNumber<long long, long(1E9)> >
    PrimTypes;
