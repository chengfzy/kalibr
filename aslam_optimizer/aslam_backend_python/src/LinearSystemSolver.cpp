...
void exportLinearSystemSolver() {
    ...
    class_<DenseQrLinearSystemSolver, boost::shared_ptr<DenseQrLinearSystemSolver>, bases<LinearSystemSolver> >(
        "DenseQrLinearSystemSolver", init<>());
    class_<BlockCholeskyLinearSystemSolver, boost::shared_ptr<BlockCholeskyLinearSystemSolver>,
           bases<LinearSystemSolver> >("BlockCholeskyLinearSystemSolver", init<>());
    class_<SparseCholeskyLinearSystemSolver, boost::shared_ptr<SparseCholeskyLinearSystemSolver>,
           bases<LinearSystemSolver> >("SparseCholeskyLinearSystemSolver", init<>());
    class_<SparseQrLinearSystemSolver, boost::shared_ptr<SparseQrLinearSystemSolver>, bases<LinearSystemSolver> >(
        "SparseQrLinearSystemSolver", init<>())
