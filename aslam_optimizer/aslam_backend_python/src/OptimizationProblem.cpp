...
void exportOptimizationProblem() {
    class_<OptimizationProblemBase, boost::shared_ptr<OptimizationProblemBase>, boost::noncopyable>(
        "OptimizationProblemBase", no_init)
    ...
    class_<OptimizationProblem, boost::shared_ptr<OptimizationProblem>, bases<OptimizationProblemBase> >(
        "OptimizationProblem", init<>())
    ...
    class_<SimpleOptimizationProblem, boost::shared_ptr<SimpleOptimizationProblem>, bases<OptimizationProblemBase> >(
        "SimpleOptimizationProblem", init<>())
        /// \brief Add a design variable to the problem.
