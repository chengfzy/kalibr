...
class LinearSolverCSparse : public LinearSolver<MatrixType> {
  public:
    LinearSolverCSparse() : LinearSolver<MatrixType>() {
    ...
    bool solve(const SparseBlockMatrix<MatrixType>& A, double* x, double* b) {
        ...
        if (x != b) memcpy(x, b, _ccsA->n * sizeof(double));
    ...
    bool solveBlocks(double**& blocks, const SparseBlockMatrix<MatrixType>& A) {
        ...
        if (numericCholesky) {
            ...
            mcc.setCholeskyFactor(_ccsA->n, numericCholesky->L->p, numericCholesky->L->i, numericCholesky->L->x,
  ...
  protected:
    ...
    void fillCSparse(const SparseBlockMatrix<MatrixType>& A, bool onlyValues) {
        ...
        if (onlyValues) {
            ...
            int nz = A.template fillCCS<int>(_ccsA->p, _ccsA->i, _ccsA->x, true);
            (void)nz;
